...
const Concussion = new Caliber(CaliberType.Shrapnel, "Concussion", 25, 0.05, 1000);
const Fragmentation = new Caliber(CaliberType.Shrapnel, "Fragmentation", 25, 0.1, 1000);
